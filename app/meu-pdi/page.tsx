...
import { FileText, MessageSquare, Plus, Trash2, ExternalLink } from 'lucide-react';
import { PlanoGerado } from '@/components/pdi/PlanoGerado';

type Tab = 'plano' | 'documentos' | 'feedbacks';
...
export default function MeuPdiPage() {
  ...
  if (carregando) return <div className="p-12 text-center">Carregando...</div>;
  ...
  return (
    <div className="flex flex-col w-full bg-cream min-h-screen">
      ...
      <div className="flex-1 max-w-7xl mx-auto w-full px-6 py-8">
        {activeTab === 'plano' && <PlanoGerado mentoradoId={mentoradoId} />}
            ...
            <div className="bg-paper rounded-xl border border-line p-6 mb-8">
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="flex items-center gap-2 bg-brown-deep hover:bg-brown text-white px-6 py-2 rounded-lg transition-colors"
                >
                  <Plus size={16} />
                  Adicionar Documento
                </button>
