...
export default function MeuPlanoPage() {
  ...
  return (
    <div style={{ maxWidth: 860, margin: "0 auto", padding: "48px 24px", fontFamily: "Poppins, sans-serif", color: "#362b21" }}>
      {!plano && (
        <div style={{ textAlign: "center", padding: "64px 24px" }}>
          <p className="display" style={{ fontSize: 26, color: "#3c2c1f", marginBottom: 12 }}>
      ...
      {plano && (
        <>
          <header style={{ marginBottom: 40 }}>
            <p className="display" style={{ fontSize: 30, color: "#3c2c1f", margin: "0 0 6px" }}>
              Meu plano
            </p>
